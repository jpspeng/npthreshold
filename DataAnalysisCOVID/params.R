...
#renv::install("Larsvanderlaan/causaltoolbox/npsurvival")
...
region_for_variant <- "LatAm"
tf_by_variant <- tfinal.tpeak.ls[[region_for_variant]]
variant_names <- names(tf_by_variant)
